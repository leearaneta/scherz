...
(let [scales [:lydian :diminished]
      tensions [{:color 0.4 :dissonance 0.6 :gravity 1}
                {:color 0.2 :dissonance 0.8 :gravity 0.5}
                {:color 0 :dissonance 1 :gravity 0.5}
                {:color 0.15 :dissonance 0.15 :gravity 0}]
